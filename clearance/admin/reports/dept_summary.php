...
$summary_query .= " AND " . $required_where . " GROUP BY s.course, s.year_level, s.section_id, d.dept_name
    ORDER BY d.dept_name, s.course, s.year_level, s.section_id";
            ...
            <?php else: ?>
                <?php foreach ($grouped_summary as $rec): ?>
                    <tr>
                        ...
                        <td><?= htmlspecialchars($rec['year_level']) . ' ' . htmlspecialchars($rec['section_id']) ?></td>
