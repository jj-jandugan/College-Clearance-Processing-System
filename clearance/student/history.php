...
// --- Filter and Grouping Logic for History Table (Original Content) ---
$all_history = $clearanceObj->getStudentSignatureHistory($student_id);
$grouped_history = [];
$display_statuses = ['Approved', 'Rejected', 'Cancelled', 'Superseded'];
...
<style>
    ...
    .status-table th { text-align: center; background-color: #f2f2f2; }
    .status-table td:nth-child(1), /* Clearance ID */
    .status-table td:nth-child(5) { text-align: center; } /* Status */
    .status-table td:nth-child(6) { text-align: left; } /* Remarks / Action */
            ...
            <?php if (!empty($grouped_history)): ?>
                <?php foreach ($grouped_history as $clearance_id => $signatures): ?>
                    <?php foreach ($signatures as $h):
                        ...
                        // --- FIX: Rename Superseded status for user display ---
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                if ($raw_status === 'Approved') {
                                    ...
                                    // Show remarks for any final negative status
