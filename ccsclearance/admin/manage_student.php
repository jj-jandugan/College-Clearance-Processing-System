                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td><?= htmlspecialchars($student['year_level']) . ' / ' . htmlspecialchars($student['section']) ?></td>
        ...
        <div class="modal-content">
            ...
            <form id="editStudentForm" method="POST" action="manage_student.php">
                ...
                <div style="display: flex; flex-wrap: wrap; gap: 10px;">
                    ...
                    <div class="form-group" style="flex: 1 1 30%;"><label for="edit_section">Section:</label><input type="text" name="section" id="edit_section" required></div>
