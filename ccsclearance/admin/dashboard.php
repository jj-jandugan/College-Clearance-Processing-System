...
<?php include '../includes/burger_menu.php'; ?>
...
<div class="sidebar" id="sidebar">
        ...
        <a href="manage_clearance.php">Manage Clearance</a>
    ...
    <div class="main-content">
        ...
        <div class="page-content-wrapper">
            ...
            <div class="kpi-grid">
                ...
                <div class="kpi-card-image" onclick="window.location.href='reports/faculty_report.php'" style="cursor: pointer;">
                ...
                <div class="kpi-card-image" onclick="window.location.href='reports/pending_list.php'" style="cursor: pointer;">
                    <div class="metric-value"><?= htmlspecialchars($card_data['total_requests']) ?></div>
                    <div class="metric-label">Total Clearance Requests</div>
                </div>

                <div class="kpi-card-image" onclick="window.location.href='reports/completed_list.php'" style="cursor: pointer;">
