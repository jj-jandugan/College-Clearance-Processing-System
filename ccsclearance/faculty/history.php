...
if ($_SERVER["REQUEST_METHOD"] === "POST" && isset($_POST['update_profile'])) {
    ...
    if (isset($_FILES['profile_picture']) && $_FILES['profile_picture']['error'] == UPLOAD_ERR_OK) {
        ...
        $new_pic_filename = "faculty_" . $signer_id . "_" . time() . "." . $file_extension;
...
if (strpos($current_pic_name, 'faculty_') === 0 || strpos($current_pic_name, 'signer_') === 0) {
...
$history_filter = (is_numeric($filter_value)) ? $filter_value : null;
$signed_history = $signerObj->getHistoryRequests($signer_id, $search_term, $history_filter);
    ...
    <div class="page-content-wrapper">
        ...
        <table>
            ...
            <tbody>
                ...
                <?php else: ?>
                    <tr>
                        <td colspan="5" style="text-align:center;">No history records found<?= ($search_term || $filter_value) ? " matching the criteria." : "." ?></td>
                    </tr>
                <?php endif; ?>
            </tbody>
        </table>
